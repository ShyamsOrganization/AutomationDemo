...
from src.business_controls_framework.controls.C123.control import C123Control


class TestC123Control(unittest.TestCase):
    """Tests for the C123 control."""
