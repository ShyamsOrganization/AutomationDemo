"""
Range Assertion for C456

This module provides an assertion for checking that values are within a specified range.
Specifically used by C456 control to verify interest rates are within acceptable limits.
"""
...
class RangeAssertion(BaseAssertion):
    """Assertion for checking that values are within a specified range."""
    ...
    def evaluate(self, data: Dict[str, Any], params: Dict[str, Any]) -> Tuple[bool, List[str]]:
        ...
        Args:
            ...
            params: Parameters for the assertion, including:
                - field: Field containing the value to check
